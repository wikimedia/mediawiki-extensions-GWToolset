...
* آیا مقداری در فرم برای "{{int:gwtoolset-record-element-name}}" وارد کرده‌اید؟ 
* آیا پوشهٔ ایکس‌ام‌ال به خوبی شکل گرفته‌است؟ $1 را امتحان کنید.
$2',
	...
	'gwtoolset-step-1-instructions-2' => 'در این مرحله، شما یک پوشهٔ فرادادهٔ جدید را به ویکی منتقل می‌کنید. ابزار برای خلاصهٔ زمینه‌های فرادادهٔ در دسترس در پوشهٔ فراداه کوشش خواهدکرد، که سپس شما برای یک الگوی مدیاویکی در "{{int:gwtoolset-step-2-heading}}" نقشه‌برداری خواهیدکرد.',
...
$messages['he'] = array(
	...
	'grouppage-gwtoolset' => '{{ns:project}}:ערכת כלי גלאם ויקי',
	'gwtoolset-batchjob-creation-failure' => 'לא היתה אפשרות ליצור משימת אצווה מסוג "$1".',
...
$1',
	...
	'gwtoolset-fsfile-retrieval-failure' => 'לא הייתה אפשרות לאחזר את הקובץ מ-URL
$1.',
	...
	'gwtoolset-xml-doctype' => 'קובץ ה-XML לא יכול להכיל מקטע <!DOCTYPE>. הסר אותו ולאחר מכן נסה שוב להעלות קובץ מטא-נתונים XML .',
	...
	'gwtoolset-over-max-ini' => 'הקובץ שהועלה חורג <code>upload_max_filesize</code> ו/או את הנחיית<code>post_max_size</code> הנמצאת ב <code>php.ini</code> .',
	'gwtoolset-partial-upload' => 'הקובץ הועלה חלקית.',
	'gwtoolset-php-extension-error' => 'הרחבת PHP עצרה את העלאת קובץ. PHP אינה מספקת דרך לברר איזו הרחבה גרמה להעלאת קובץ לעצור. בחינת רשימת סיומות טעונות עם <code>phpinfo()</code> עשויה לעזור.',
	'gwtoolset-unaccepted-extension' => 'קובץ המקור אינו מכיל סיומת מקובלת.',
	'gwtoolset-unaccepted-extension-specific' => 'קובץ המקור מכיל סיומת קובץ שאינה מקובלת "$1".',
	'gwtoolset-unaccepted-mime-type' => 'הקובץ שהועלה זוהה כבעל סוג MIME TYPE מסוג "$1", שאינו בין סוגי ה-MIME המקובלים.',
	'gwtoolset-unaccepted-mime-type-for-xml' => 'הקובץ שהועלה מכיל MIME TYPE מסוג "$1", שאינו מקובל. האם קובץ ה-XML מכיל הכרזת XML בחלק העליון של הקובץ?
<"xml version="1.0" encoding="UTF-8"?>',
	'gwtoolset-back-text-link' => '→ חזרה לטופס',
	'gwtoolset-back-text' => 'לחץ על לחצן חוזר של הדפדפן על מנת לחזור לטופס.',
	'gwtoolset-file-interpretation-error' => 'אירעה בעית עיבוד קובץ המטה-נתונים.',
...
$1',
	'gwtoolset-metadata-invalid-template' => 'לא נמצאה תבנית מדיה-ויקי חוקית.',
	'gwtoolset-menu-1' => 'מיפוי המטא־נתונים',
	'gwtoolset-technical-error' => 'אירעה שגיאה טכנית.',
	'gwtoolset-required-field' => 'מציין שדה חובה',
	...
	'gwtoolset-save-mapping-failed' => 'מצטערים. אירעה תקלה בעת עיבוד בקשתכם. נא נסו שוב מאוחר יותר. (הודעת שגיאה: $1)',
	...
	'gwtoolset-json-error-depth' => 'ישנה חריגה מעומק הערימה (stack) המירבי.',
	...
	'gwtoolset-ensure-well-formed-xml' => 'אנא ודאו כי קובץ ה-XML בנוי נכון עם "$1".',
	...
	'gwtoolset-mediafile-throttle-description' => "לאחר התצוגה המקדימה של אצווה, בצעד מס' 3, GWToolset מעלה את הרשומות הנותרות בהעלאה אצווה בתהליך שרץ ברקע. מצערת קבצי המדיה (mediafile throttle) שולטת במספר הבקשות לקובצי מדיה שויקישיתוף יעשה מול שרת קבצי המדיה בכל פעם שתהליך רץ ברקע. באפשרותך להגדיר את מצערת קבצי המדיה לערך שבין 1-20. לדוגמה, אם המספר הכולל של רשומות בהעלאת אצווה הוא 100 ומוגדרת מצערת של 20, ויקישיתוף יריץ 5 משימות ברקע על מנת לעבד את כל אצוות ההעלאה שלך. הזמן בין כל משימת העלאה ברקע משתנה בהתאם עומס בשרת והקונפיגורציה שלו; אנו צופים כי בויקישיתוף, משימת GWToolset תופעל ברקע לפחות כל 5 דקות.",
	'gwtoolset-mediawiki-template-does-not-exist' => 'תבנית מדיה ויקי "<strong> $1 </strong>" אינה קיימת בויקי.

ייבא את התבנית או בחר תבנית ויקי אחרת לשימוש עבור המיפוי.',
	'gwtoolset-mediawiki-template-not-found' => 'תבנית מדיה ויקי "$1" לא נמצאה.',
	'gwtoolset-metadata-file-source' => 'בחר את מקור קובץ המטא-נתונים.',
	...
	'gwtoolset-metadata-mapping-bad' => 'קיימת בעיה עם מיפוי המטא-נתונים. קרוב לוודאי שתבנית ה-JSON אינה חוקית. נסו לתקן את הבעיה ולאחר מכן לשלוח את הטופס שוב.

$1',
	'gwtoolset-metadata-mapping-not-found' => 'לא נמצא מיפוי מטא-נתונים.

הדף "<strong>$1<strong>" לא נמצא בוויקיפדיה.',
...
הדף צריך להיות במרחב השם "<strong>$3<strong>"',
	'gwtoolset-page-title-contains-url' => 'הדף $1 מכיל את כל כתובת ה-URL. הקפד להזין רק את כותרת הדף, למשל את החלק של ה-URL שאחרי /wiki/',
	'gwtoolset-record-element-name' => 'מהו רכיב ה-XML המכיל כל רשומת מטה-נתונים:',
	'gwtoolset-step-1-heading' => 'שלב 1: זיהוי המטה-נתונים',
	'gwtoolset-step-1-instructions-1' => 'תהליך העלאת המטה-נתונים כולל 4 שלבים:',
	'gwtoolset-step-1-instructions-li-1' => 'זיהוי המטה-נתונים',
	'gwtoolset-step-1-instructions-li-2' => 'מיפוי המטא־נתונים',
	'gwtoolset-step-1-instructions-li-3' => 'תצוגה מקדימה של אצווה',
	'gwtoolset-step-1-instructions-li-4' => 'ההעלאת אצווה',
	'gwtoolset-upload-legend' => 'העלאת קובץ המטה-נתונים שלך',
	'gwtoolset-which-mediawiki-template' => 'איזה תבנית מדיה-ויקי',
	'gwtoolset-which-metadata-mapping' => 'איזה מיפוי מטה-נתונים',
	'gwtoolset-xml-error' => 'טעינת ה-XML נכשלה. אנא תקן את השגיאות הבאות.',
	...
	'gwtoolset-mapping-media-file-url-bad' => 'לא ניתן היה לחשב את כתובת קובץ המדיה. הכתובת מעבירה את התוכן בצורה שלא נתמכת עדיין על־ידי הסיומת הזאת או שהייתה בעיה בבקשת ה־HTTP. הכתובת שניתנה היא "$1". שגיאת בקשת ה־HTTP היא "$2"',
	...
	'gwtoolset-step-2-instructions-1-li-3' => 'רשומת מדגם מתוך קובץ המטא-נתונים.',
	'gwtoolset-reupload-media' => 'העלה מחדש מדיה מ-URL',
	...
	'gwtoolset-step-3-instructions-heading' => 'שלב 3: תצוגה מקדימה של אצווה',
	'gwtoolset-step-3-instructions-3' => 'אם אינך שבע רצון מהתוצאות, חזור ל"{{int:gwtoolset-שלב-2-כותרת}}" והתאם את המיפוי לפי הצורך.

אם עליך לבצע שינויים בקובץ מטה-נתונים עצמו, כנס לקובץ ובצע את השינויים, לאחר מכן העלה אותו מחדש על-ידי תחילת התהליך מחדש מ"{{int:gwtoolset-שלב-1-כותרת}}".',
...
<strong>כותרת לא חוקית:</strong> $1.',
	...
	'gwtoolset-step-4-heading' => 'שלב 4: ההעלאת אצווה',
